<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"template/default/tag_list.html";i:1494693335;s:30:"./template/default/header.html";i:1494754851;s:30:"./template/default/footer.html";i:1494689466;}*/ ?>
...
<div class="weizhi-1">当前位置： <a href="__ROOT__">首页</a> > TAG标签</div>
<div class="main1">
	<div class="left-3 fl">
      	<dl class="b-box15">
			<dt><span>最新标签</span></dt>
                <dd>
                	<?php $__LIST__ = db('tag')->order("tagid desc")->limit(50)->select();if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a style="color:#<?php echo random_color(); ?>; font-size:<?php echo rand(12,18); ?>px;" href='__ROOT__/index.php/tag/tag.html?tag=<?php echo urlencode($vo['tag']); ?>'><?php echo $vo['tag']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
				</dd>
                <dt><span>热门标签</span></dt>
                <dd>
                	<?php $__LIST__ = db('tag')->order("hits desc")->limit(50)->select();if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a style="color:#<?php echo random_color(); ?>; font-size:<?php echo rand(12,18); ?>px;" href='__ROOT__/index.php/tag/tag.html?tag=<?php echo urlencode($vo['tag']); ?>'><?php echo $vo['tag']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
				</dd>
                <dt><span>随机标签</span></dt>
                <dd>
                	<?php $__LIST__ = db('tag')->order("rand()")->limit(50)->select();if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <a style="color:#<?php echo random_color(); ?>; font-size:<?php echo rand(12,18); ?>px;" href='__ROOT__/index.php/tag/tag.html?tag=<?php echo urlencode($vo['tag']); ?>'><?php echo $vo['tag']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
				</dd>
		</dl>  
