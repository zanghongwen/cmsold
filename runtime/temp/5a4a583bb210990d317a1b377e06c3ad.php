<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/Users/mac/Documents/mamp/cms/application/admin/view/category/add.html";i:1492089570;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1493279924;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span>添加栏目</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo url('Category/add'); ?>" method="post"  id="form" enctype="multipart/form-data" >
                    <ul class="admin_tab">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                         <tr>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td ><?php echo form_editor('content',''); ?></td>
                            </tr>
