<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/Users/mac/Documents/mamp/cms/application/admin/view/template/index.html";i:1492768340;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1493279924;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">模板风格</span></div>
        </div>
       
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="<?php echo url('Template/updatename'); ?>">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td><input type="text" name="name[<?php echo $vo['dirname']; ?>]" value="<?php echo $vo['name']; ?>" /></td>
                            <td><?php echo $vo['author']; ?></td>
                            <td><?php echo $vo['version']; ?></td>
                            <td><a  href="<?php echo url('Template/disable',['style'=>$vo['dirname']]); ?>"><?php echo !empty($vo['disable'])?'正常':'停用'; ?></a></td>
                            <td><a  href="<?php echo url('Tfile/index',['style'=>$vo['dirname']]); ?>">详情列表</a></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr><td colspan="6"><input class="btn btn-primary btn2" value="更新" type="submit"></td></tr>
                    </table>
