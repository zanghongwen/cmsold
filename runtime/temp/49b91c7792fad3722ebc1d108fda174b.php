<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/Users/mac/Documents/mamp/cms/application/admin/view/flink/index.html";i:1496055103;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1496236530;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a onclick="myform.action='<?php echo url('Flink/status'); ?>';myform.submit();" href="javascript:void(0)"><i class="icon-font"></i>更新状态</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr align="center">
                            ...
                            <td><?php echo !empty($vo['status'])?'有效':'<font color=red>无效</font>'; ?></td>
                            <td>
