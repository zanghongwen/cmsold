<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/Users/mac/Documents/mamp/cms/application/admin/view/flink/edit.html";i:1494481426;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1493279924;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo url('Flink/index'); ?>">友情链接</a><span class="crumb-step">&gt;</span><span>修改友情链接</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo url('Flink/edit'); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                          <tr>
                                <th>标题：</th>
                                <td>
                                    <input class="common-text" id="title" name="title" value="<?php echo $result['title']; ?>" type="text" >
                                </td>
                            </tr>
                            <tr>
                                <th>地址：</th>
                                <td>
                                    <input class="common-text" id="url" name="url" value="<?php echo $result['url']; ?>" style=" width:800px;" type="text" >
                                </td>
                            </tr>
                           
                                <tr>
                                <th>图片：</th>
                                <td><?php echo form_image('logo',$result['logo']); ?></td>
                            </tr>
