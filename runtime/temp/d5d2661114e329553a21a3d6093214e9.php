<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:26:"template/default/list.html";i:1494758959;s:30:"./template/default/header.html";i:1494754851;s:30:"./template/default/footer.html";i:1494689466;}*/ ?>
	...
	<div class="left-3 fl">
      	<ul class="g-list">
        	...
        	<li>
                ...
                <p>[<a href="<?php echo get_caturl($vo['catid']); ?>"><?php echo get_catname($vo['catid']); ?></a>]  <?php echo date("Y-m-d H:i:s",$vo['inputtime']); ?>  <?php echo get_hits($vo['id']); ?>人阅读 
                TAG:<?php $keywords=kw_to_array($vo['keywords']); foreach($keywords as $v){ ?>
                    <a style="color:#<?php echo random_color(); ?>;" href="__ROOT__/index.php/tag/tag.html?tag=<?php echo urlencode($v); ?>"><?php echo $v; ?></a>
                    <?php } ?>
                </p>
