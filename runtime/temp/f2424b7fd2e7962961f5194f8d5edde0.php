<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"template/default/category.html";i:1494695888;s:30:"./template/default/header.html";i:1494754851;s:30:"./template/default/footer.html";i:1494689466;}*/ ?>
...
<div class="main1">
	<div class="left-3 fl">
    	<?php foreach(subcatelist($catid) as $k=>$v): ?>
        <div class="g-box7">
        	<div class="t-5">
            	<span><a href="<?php echo $v['url']; ?>">&raquo;更多</a></span>
            	<h3><a href="<?php echo $v['url']; ?>"><?php echo $v['catname']; ?></a></h3>
            </div>
            <ul class="b-box8 fl">
            	<?php foreach(subarclist($v['catid'],4,0) as $v1): ?>
                <li><a href="<?php echo $v1['url']; ?>"><img src="<?php echo $v1['thumb']; ?>"  /><?php echo $v1['title']; ?></a></li>
                <?php endforeach; ?>
                <div class="cl"></div>
            </ul>
            <ul class="b-box9 fr">
            	<?php foreach(subarclist($v['catid'], 4,9) as $v2): ?>
                <li><span><?php echo date("m-d",$v2['inputtime']); ?></span><a href="<?php echo $v2['url']; ?>"><?php echo $v2['title']; ?></a></li>
                 <?php endforeach; ?>
            </ul>
            <div class="cl"></div>
        </div>
