<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/Users/mac/Documents/mamp/cms/application/admin/view/article/add.html";i:1494494416;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1496236530;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <form action="<?php echo url('Article/add'); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <input type="checkbox" name="posid[]" value="<?php echo $vo['posid']; ?>" /><?php echo $vo['name']; endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <tr>
                                <th>标题：</th>
                                <td>
                                    <input class="common-text" id="title" name="title" onBlur="$.post('__ROOT__/api.php/keyword/get_keywords.html?number=3&sid='+Math.random()*5, {data:$('#title').val()}, function(data){if(data && $('#keywords').val()=='') $('#keywords').val(data); })" style=" width:800px;" type="text" >
                                </td>
                            </tr>
                            <tr>
                                <th>关键词：</th>
                    ...
                    <table class="insert-tab" width="100%" border="1">
                        <tbody>
                           <tr>
                                <th width="80">组图：</th>
                                <td><?php echo form_images('gallery'); ?></td>
                            </tr>
