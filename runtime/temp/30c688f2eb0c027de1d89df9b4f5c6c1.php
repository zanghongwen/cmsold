<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:26:"template/redblog/show.html";i:1492849343;s:30:"./template/redblog/header.html";i:1494755457;s:30:"./template/redblog/footer.html";i:1492847586;}*/ ?>
	...
	<div id="templatemo_main">
		<div id="templatemo_main_top">
    		...
    		<div class="post_section">
            	...
            	<div class="post_date">
                	<?php echo date("d",$article['inputtime']); ?><span><?php echo date("m",$article['inputtime']); ?></span>
            	</div>
                <div class="post_content">
                
                    <h2><?php echo $article['title']; ?></h2>
                    
                	<strong>作者:</strong> <?php echo $article['username']; ?> | <strong>分类:</strong> <?php echo get_catname($article['catid']); ?>
