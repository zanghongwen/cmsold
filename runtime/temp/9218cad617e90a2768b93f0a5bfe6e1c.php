<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/Users/mac/Documents/mamp/cms/application/admin/view/user/group_add.html";i:1492085908;s:71:"/Users/mac/Documents/mamp/cms/application/admin/view/public/header.html";i:1493279924;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span>添加会员组</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo url('User/group_add'); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%" border="1">
                        <tbody>
                            ...
                            <tr>
                                <th width="100">名称：</th>
                                <td>
                                    <input class="common-text" id="name" name="name" type="text" >
                                </td>
                            </tr>
                             <tr>
                                <th width="100">积分：</th>
                                <td>
                                    <input class="common-text" id="point" name="point" type="text" >
                                </td>
                            </tr>
                             <tr>
                             <th></th>
