<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\wamp64\www\fivecms/application/admin\view\article\index.html";i:1494693912;s:63:"D:\wamp64\www\fivecms/application/admin\view\public\header.html";i:1493283523;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <table class="search-tab">
                        <tr>
                            ...
                            <td>
                             ...
                             <th width="70">作者:</th>
                            <td><input class="common-text" placeholder="会员名" name="username" value="<?php echo !empty($username)?$username:''; ?>"  type="text"></td>
                            <th width="70">关键字:</th>
